public class Main {
    public static void main(String[] args)
    {
        ...
        Book book1 = new Book("Евегений Онегин", author1.surname, 1820);
        Book book2 = new Book("Собачье сердце", author2.surname, 1925);

        System.out.println("book1.getYearPublication() = " + book1.getYearPublication());
        book1.setYearPublication(1823);
        System.out.println("book1.getYearPublication() = " + book1.getYearPublication());
        System.out.println("book1.getString() = " + book1.getString());
        System.out.println("book1.getAuthor() = " + book1.getAuthor());
        System.out.println("book2.getString() = " + book2.getString());
